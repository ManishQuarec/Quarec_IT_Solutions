...
export default function Career() {
  ...
  useEffect(() => {
    ...
    axios
      .get(process.env.REACT_APP_API_KEY + "/api/job_title")
      .then((response) => {
        setJobTitel(response.data.position);
  ...
  // Now you can use openingData and categoryData separately in your component.
      ...
      <section className="career-section-wrapper">
        <div className="container paddingleftright">
          <div className="carrers-heading-title-wrapper">
            ...
            <div className="career-discription">
              <p>
                Quarec IT Solutions is all about innovative excellence. If you
                are a thinker, an innovator, we’d love to hear from you.
              </p>
            </div>
          </div>
              ...
              <div className="career-together-wrapper width50 oneo-oneo">
                ...
                <div className="career-discription-wrapper">
                  <div className="career-explain">
                    <p>
                      Quarec IT Solutions provides the best work culture where
                      you can explore your skills and have a good career
                      exposure. We are always on the look-out for creative
                      out-of-the-box thinkers to join our team. We offer
                      outstanding professional development and competitive
                      compensation and benefits. Strengthen your skills and
                      build a career working on exciting international projects!
                    </p>
                  </div>
                  <div className="career-small">
                ...
                <div className="career-mail-wrapper">
                  <div className="career-email">
                    <p>
                      <span>Email Us</span>
                      <a href="mailto:info@Quarecitsolutions.com">
                        info@Quarecitsolutions.com
                      </a>
                    </p>
                  </div>
                </div>
          ...
          <div className="question-and-informaion-wrapper">
            <div className="d-flex justify-content-between gapinforamtion">
              <div className="developer-information-form width50 wecanadjust ">
                ...
                <div className="schedule-interview-from-wrapper">
                  ...
                  <form
                    action=""
                    method="post"
                    className="fillform-for-interview"
                    onSubmit={(e) => {
                      handleSubmit(e);
                    }}
                  >
                    ...
                    <div className="discribe-massege">
                      ...
                      <textarea
                        ...
                        rows="5"
                        cols="60"
                        placeholder="Description Of Your Business Challenge"
                        onChange={(e) => {
                    ...
                    <div className="save-information-wrapper">
                      <div className="save-information">
                        ...
                        <p>
                          We all know how important your informations is.They
              ...
              <div className="faq-section-wrapper width50 wecanadjust">
                ...
                >
                  {/* <!-- Accordion card --> */}
                  {/* {openingData.map((getopening, index) => (
                    <div className="card requirement-skiils">
                      ...
                      >
                        ...
                        >
                          <a key={index}>{getopening.title}</a>
                          <span>
                  ...
                  >
                    {openingData.map((getopening, index) => (
                      <div className="card requirement-skiils" key={index}>
                        <div
                          className="faq-inner-wrapper"
                          role="tab"
                          id={`headingTwo${index}`}
                  ...
                  {/* <div className="card requirement-skiils">
                    ...
                    >
                      <a
                        ...
                        data-toggle="collapse"
                        data-parent="#accordionEx1"
                        href="#collapseThree51"
                        aria-expanded="false"
                        aria-controls="collapseThree51"
                      >
                    ...
                    <div
                      ...
                      className="collapse"
                      role="tabpanel"
                      aria-labelledby="headingThree51"
                      data-parent="#accordionEx1"
                    >
                      <div className="card-body">
                        Anim pariatur cliche reprehenderit, enim eiusmod high
                  ...
                  {/* <div className="card requirement-skiils">
                    ...
                    >
                      <a
                        ...
                        data-toggle="collapse"
                        data-parent="#accordionEx1"
                        href="#collapseThree61"
                        aria-expanded="false"
                        aria-controls="collapseThree61"
                      >
                        Android Native Developer [3-Posts] [Experience 0-3+
                        Years ]
                        <span>
                          <i
                            className="fa fa-plus rotate-icon"
                    ...
                    <div
                      ...
                      className="collapse"
                      role="tabpanel"
                      aria-labelledby="headingThree61"
                      data-parent="#accordionEx1"
                    >
                      <div className="card-body">
                        Anim pariatur cliche reprehenderit, enim eiusmod high
                  ...
                  {/* <div className="card requirement-skiils">
                    ...
                    >
                      <a
                        ...
                        data-toggle="collapse"
                        data-parent="#accordionEx1"
                        href="#collapseThree71"
                        aria-expanded="false"
                        aria-controls="collapseThree71"
                      >
                    ...
                    <div
                      ...
                      className="collapse"
                      role="tabpanel"
                      aria-labelledby="headingThree71"
                      data-parent="#accordionEx1"
                    >
                      <div className="card-body">
                        Anim pariatur cliche reprehenderit, enim eiusmod high
            ...
            <div className="d-flex justify-content-between overviewgap">
              <div className="department-wrappere">
                <div className="deparment-item yellow">
                  <span className="data-number" data-number="6">
                    6
                  </span>
                  <h1>Departments</h1>
                </div>
              ...
              <div className="department-wrappere">
                <div className="deparment-item yellow">
                  <span className="data-number" data-number="22">
                    22
                  </span>
              ...
              <div className="department-wrappere">
                <div className="deparment-item yellow">
                  <span className="data-number" data-number="25">
                    25
                  </span>
              ...
              <div className="department-wrappere">
                <div className="deparment-item yellow">
                  <span className="data-number" data-number="328">
                    328
                  </span>
                  <h1>Pizzas</h1>
                </div>
