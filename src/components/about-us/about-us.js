                ...
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <div class="relativeeeee">
                      ...
                      <img class="arrow-one" src="assets/images/Frame 2231.png" />
                    </div>
                  </div>
                ...
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <div class="telescope-rel">
                      <img class="telescope" src="assets/images/Group 2263.png" />
              ...
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere width-increase">
                  <div className="black-img teleone">
                    <div class="telescope-rel">
                      <img class="weight-one" src="assets/images/Group 2265.png" />
                      <img class="stand-weight" src="assets/images/Group 2266.png" />
                    </div>
                  </div>
                </div>
