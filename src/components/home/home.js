...
export default function Home(props) {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      let res = await fetch(
        "https://be33-43-249-54-66.in.ngrok.io/api/addcontact",
        {
          method: "POST",
                    ...
                    <div className="d-flex justify-content-between align-items-center gap">
                        <div className="first-section width50">
                            <div className="we-section-content">
                                ...
                                <div className="view-button"><button onClick={() => { navigate("/Get_in_Touch") }}>Get In Touch</button></div>
                            </div>
                        </div>
              ...
              <div className="d-flex inner-flex-wrapper">
                <div className="content-imge-wrapper">
                  <div className="content-img">
                    <img src="assets/images/sidecontentimg.png" />
                  </div>
                </div>
                <div className="content-wrapper">
              ...
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <img src="assets/images/bookpencil.png" alt="not found" />
                  </div>
                </div>
                <div className="sideimage-wrapper">
                  <div className="sideimg">
          ...
          <div className="d-flex justify-content-between align-items-center gap20">
            ...
            <div className="plain-and-Process-wrapper width33.33">
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <img src="assets/images/uidesign.png" alt="not found" />
                  </div>
                </div>
              </div>
              <div className="web-heading leftafter">
            ...
            <div className="plain-and-Process-wrapper width33.33">
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <img src="assets/images/website.png" alt="not found" />
                  </div>
                </div>
              </div>
              <div className="web-heading leftafter">
            ...
            <div className="plain-and-Process-wrapper width33.33">
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <img src="assets/images/hubspot.png" alt="not found" />
                  </div>
                </div>
            ...
            <div className="plain-and-Process-wrapper width33.33">
              <div className="d-flex justify-content-between">
                <div className="black-img-wrappere">
                  <div className="black-img">
                    <img
                      src="assets/images/mailmarketing.png"
                      alt="not found"
                    />
                  </div>
                </div>
                    ...
                    <ul className="media-links">
                      ...
                      <li>
                        <a href="#">
                          <img
                            className="team-one-icon"
                            src="assets/images/linkdeen.png"
                          />
                        </a>
                      </li>
                    </ul>
                        ...
                        <div className="contact-form-inner-wrapper">
                            <div className="inner-wrapper-content">
                                <form method='POST' className="contact-form" onSubmit={(e) => { handleSubmit(e) }}>
                                    <div className="input-field">
                                        <input value={txt} onChange={onInputChange} autoComplete="off" placeholder="name" required={true} className="form-control fleidclassName" />
                                    </div>
                                    <div className="input-field">
                                    ...
                                    <div className="input-field">
                                        <input type="number" autoComplete="off" placeholder="phone" required={true} className="form-control fleidclassName" value={phone} onChange={handlephone} />
                                    </div>
                                    <div className="input-field">
