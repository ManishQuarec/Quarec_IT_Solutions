          ...
          <div className="portfolio-tabs-wrapper-section">
            <div className="inner-portfolio-tabs-wrapper">
              <div className="tabs-wrapper">
                <ul
                  className="nav nav-tabs align-items-center justify-content-between "
                  id="nav-tab"
                  role="tablist"
                >
                  <li>
              ...
              {/* <div className="tabs-wrapper">
                ...
                >
                  <li className="border-radius">
                    <a
                      className="nav-item movetabs active "
                      role="tab"
                      aria-selected="true"
                      href="#1"
                      data-toggle="tab"
                  ...
                  <li className="border-radius-left" id="border-round-6">
                    <a
                      className="nav-item movetabs"
                      href="#6"
                      role="tab"
